export const projectsData = [
  {
    ...
    skills: ["Tailwind", "Typescript", "NextJs"],
    descripcion:
      "Explorador de Países es una aplicación web para descubrir, filtrar y guardar países favoritos del mundo.",
    demoURL: "https://explorador-de-paises-rb.vercel.app",
    repoURL: "https://github.com/BlackDoubleB/app-paises.git",
    anim: "fade-left",
  },

  {
    imgSrc:
      "https://res.cloudinary.com/doublebl/image/upload/v1757639628/portada_reyno_verde_gqwe51.png",
    title: "Tienda de Plantas",
    skills: ["Tailwind", "Typescript", "Angular", "CS", "NET", "SQL"],
    descripcion:
      "Reyno Verde es una aplicación web enfocada en la venta y gestión de plantas. El proyecto ofrece un catálogo variado de plantas, donde los usuarios pueden explorar, elegir y comprar de manera sencilla.",
  ...
  {
    imgSrc:
      "https://res.cloudinary.com/doublebl/image/upload/v1758577698/favoribooks_gu1lgk.png",
  ...
  {
    imgSrc:
      "https://res.cloudinary.com/doublebl/image/upload/v1758496346/project-market_omvrcx.png",
    title: "Tienda de Variados",
    skills: [ "Typescript", "NextJs", "postgresql"],
    descripcion:
